...
public class Server : MonoBehaviour {
    //One person will have instance of server class.
    
            // port and IP adrress changed.. checkvictory brought to start function.


        // IP address, an open port.
    public int port = 9876;

    private List<ServerClient> clients;
    private List<ServerClient> disconnectLists;
    ...
    public void Init()
    {
        ...
        {
            Debug.Log("Socket err: " + e.Message);            
        }
    }
    private void Update() {
        if (!serverStarted)
    ...
    private void StartListening() {
        //Incomming connection acceptance.
